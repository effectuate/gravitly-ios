...
@interface MainMenuViewController : GVBaseViewController <UINavigationControllerDelegate, NMPaginatorDelegate, UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate>
